...
function drawAssemblyMap(selector, datasource, stCode ,settings, dropSelect, constBox, dsrc, dcode, defdist){
    var constwisetrenddata = (function() {
        ...
        jQuery.ajax({
            ...
            'success': function(data) {
                ...
                if ((datasource == "https://thefederal.com/api/scraper.php?m=election2022_result&t=constituency_result")||(datasource == "data/const2022data.json")) {
                    console.log(data);
    ...
    d3.json(source, function(error, stateShape){
        ...
        svg.selectAll(".const")
            ...
            .on('click', function(d,i){
                ...
                if (datasource == "data/const2017data.json") {
                    economicFilter(dist)
                }
    ...
    function filterNDisplay2017(acno){
        ...
        // console.log(len);
            ...
            d3.select(constBox + " .trailParty").html(fdTrendData2017[0]["trailingParty"]);
...
function responsive(maxWidth) {
    if (maxWidth.matches) { 
        ...
        drawAssemblyMap(".mn-map2017", 'data/const2017data.json?v=4563', "mn_conswise", {
        ...
        drawAssemblyMap(".uk-map2017", 'data/const2017data.json?v=4563', "uk_conswise", {
            statecode: 'S02', // Statecode for map
        ...
        drawAssemblyMap(".up-map2017", 'data/const2017data.json?v=4563', "up_conswise", {
        ...
        drawAssemblyMap(".pb-map2017", 'data/const2017data.json?v=4563', "pb_conswise", {
        ...
        drawAssemblyMap(".ga-map2017", 'data/const2017data.json?v=4563', "ga_conswise", {
            statecode: 'S30', // Statecode for map
        ...
        // drawAssemblyMap(".ga-map2022", 'https://thefederal.com/api/scraper.php?m=election2022_result&t=constituency_result', "go_conswise", {
        //     statecode: 'S30', // Statecode for map
        //     vhcode: 'ga', // state vehicle code
        //     defaultconst: 21, // state vehicle code
        //     mapsource: 'maps/goaMap.json', // add map topojson
        ...
        // }, "#gaconstList2022", "#ga-2022", "data/economicFactors.json", "", "");
        
        // drawAssemblyMap(".pb-map2022", 'https://thefederal.com/api/scraper.php?m=election2022_result&t=constituency_result', "pu_conswise", {
        //     statecode: 'S30', // Statecode for map
        //     vhcode: 'pb', // state vehicle code
        //     defaultconst: 21, // state vehicle code
        //     mapsource: 'maps/Punjab.json', // add map topojson
        //     scale: 7500, // size adjust until it sits well
        //     center: [75.4, 30.8] // enter lat long from google of UP
        // }, "#pbconstList2022", "#pb-2022", "data/economicFactors.json", "", "");
        
        //  drawAssemblyMap(".mn-map2022", 'https://thefederal.com/api/scraper.php?m=election2022_result&t=constituency_result', "mp_conswise", {
        //     statecode: 'S02', // Statecode for map
        //     vhcode: 'mn', // state vehicle code
        //     defaultconst: 21, // state vehicle code
        //     mapsource: 'maps/manipur.json', // add map topojson
        //     scale: 12500, // size adjust until it sits well
        //     center: [93.9462, 24.7] // enter lat long from google of UP
        // }, "#mnconstList2022", "#mn-2022", "data/economicFactors.json", "", "");

        // drawAssemblyMap(".uk-map2022", 'https://thefederal.com/api/scraper.php?m=election2022_result&t=constituency_result', "uk_conswise", {
        //     statecode: 'S02', // Statecode for map
        //     vhcode: 'uk', // state vehicle code
        //     defaultconst: 21, // state vehicle code
        //     mapsource: 'maps/uttarakhand.json', // add map topojson
        //     scale: 4500, // size adjust until it sits well
        //     center: [78.4, 31] // enter lat long from google of UP
        // }, "#ukconstList2022", "#uk-2022", "data/economicFactors.json", "", "");

        // drawAssemblyMap(".up-map2022", 'https://thefederal.com/api/scraper.php?m=election2022_result&t=constituency_result', "up_conswise", {
        //     statecode: 'S24', // Statecode for map
        //     vhcode: 'up', // state vehicle code
        //     defaultconst: 21, // state vehicle code
        //     mapsource: 'maps/UP.json', // add map topojson
        //     scale: 3000, // size adjust until it sits well
        //     center: [80.9462, 26.7] // enter lat long from google of UP
        // }, "#upconstList2022", "#up-2022", "data/economicFactors.json", "", "");
        ...
        //     center: [78.4, 31.2] // enter lat long from google of UP
        // }, "#ukconstList2022", "#uk-2022", "data/economicFactors.json", "", "");
        drawAssemblyMap(".mn-map2022", 'data/const2022data.json', "mp_conswise", {
            statecode: 'S02', // Statecode for map
            vhcode: 'mn', // state vehicle code
            defaultconst: 21, // state vehicle code
            mapsource: 'maps/manipur.json', // add map topojson
